...
def reconstruct_flu(fluences, loss_fct_1, loss_fct_2=None, steps_size=1, multiprobe=None,
                    propa_distances=None, grad_weights=None, n_probes=None):
    ...
    if multiprobe == 'defocus':
        ...
        sim_probe = simulate_multiprobe_band_limited_random(
            OBJ_SIZE, r_ratio=5, n_probes=n_probes
        )
